...
function Navbar({ cartCount }) {
  return (
    <nav className="navbar navbar-expand-lg fixed-top pt-0 pb-0">
      <div className="container-fluid">
        ...
        <div className="collapse text-start navbar-collapse" id="navbarSupportedContent">
          ...
          <button className="btn btn-outline-dark" id='cart-btn' type="submit">
            <BsFillCartFill style={{ fontSize: '30px', padding: '5px' }} /> Cart {cartCount}
          </button>
        </div>
      </div>
    </nav>
